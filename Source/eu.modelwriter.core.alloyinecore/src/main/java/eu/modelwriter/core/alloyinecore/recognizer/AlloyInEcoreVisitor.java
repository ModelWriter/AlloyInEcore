...
public interface AlloyInEcoreVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code domainRestriction}
	 * labeled alternative in {@link AlloyInEcoreParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDomainRestriction(AlloyInEcoreParser.DomainRestrictionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code rangeRestriction}
	 * labeled alternative in {@link AlloyInEcoreParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRangeRestriction(AlloyInEcoreParser.RangeRestrictionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExpr(AlloyInEcoreParser.ExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AlloyInEcoreParser#singleton}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleton(AlloyInEcoreParser.SingletonContext ctx);
	/**
