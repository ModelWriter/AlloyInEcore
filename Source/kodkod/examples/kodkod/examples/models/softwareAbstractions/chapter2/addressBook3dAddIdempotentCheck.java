...
public final class addressBook3dAddIdempotentCheck  {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x19=x20.no();
        Variable x24=Variable.unary("addIdempotent_this");
        ...
        Variable x32=Variable.unary("addIdempotent_this");
        ...
        Variable x58=Variable.unary("addIdempotent_this");
        Decls x57=x58.oneOf(x9);
        Variable x62=Variable.unary("addIdempotent_n");
        ...
        Variable x70=Variable.unary("addIdempotent_a");
        ...
        Variable x130=Variable.unary("addIdempotent_b");
        Decls x129=x130.oneOf(x9);
        Variable x132=Variable.unary("addIdempotent_b'");
        Decls x131=x132.oneOf(x9);
        Variable x134=Variable.unary("addIdempotent_b''");
        Decls x133=x134.oneOf(x9);
        Variable x136=Variable.unary("addIdempotent_n");
        Decls x135=x136.oneOf(x21);
        Variable x138=Variable.unary("addIdempotent_t");
        Decls x137=x138.oneOf(x39);
        Decls x128=x129.and(x131).and(x133).and(x135).and(x137);
        Formula x144=x138.in(x6);
        Expression x148=x21.intersection(x138);
        Expression x150=x130.join(x12);
        Expression x149=x150.closure();
        Expression x147=x148.join(x149);
        Expression x146=x147.intersection(x6);
        Formula x145=x146.some();
        Formula x143=x144.or(x145);
        Expression x152=x132.join(x12);
        Expression x154=x130.join(x12);
        Expression x155=x136.product(x138);
        Expression x153=x154.union(x155);
        Formula x151=x152.eq(x153);
        Formula x142=x143.and(x151);
        Formula x158=x138.in(x6);
        Expression x162=x21.intersection(x138);
        Expression x164=x132.join(x12);
        Expression x163=x164.closure();
        Expression x161=x162.join(x163);
        Expression x160=x161.intersection(x6);
        Formula x159=x160.some();
        Formula x157=x158.or(x159);
        Expression x166=x134.join(x12);
        Expression x168=x132.join(x12);
        Expression x169=x136.product(x138);
        Expression x167=x168.union(x169);
        Formula x165=x166.eq(x167);
        Formula x156=x157.and(x165);
        Formula x141=x142.and(x156);
        Formula x140=x141.not();
        Expression x171=x132.join(x12);
        Expression x172=x134.join(x12);
        Formula x170=x171.eq(x172);
        Formula x139=x140.or(x170);
        Formula x127=x139.forAll(x128);
        Formula x126=x127.not();
        Formula x173=x0.eq(x0);
        Formula x174=x1.eq(x1);
        Formula x175=x2.eq(x2);
        Formula x176=x3.eq(x3);
        Formula x177=x4.eq(x4);
        Formula x178=x5.eq(x5);
        Formula x179=x6.eq(x6);
        Formula x180=x7.eq(x7);
        Formula x181=x8.eq(x8);
        Formula x182=x9.eq(x9);
        Formula x183=x10.eq(x10);
        Formula x184=x11.eq(x11);
        Formula x185=x12.eq(x12);
        Formula x186=x13.eq(x13);
        Formula x187=x14.eq(x14);
        Formula x188=x15.eq(x15);
        Formula x16=Formula.compose(FormulaOperator.AND, x17, x19, x22, x27, x30, x53, x56, x74, x77, x81, x82, x84, x126, x173, x174, x175, x176, x177, x178, x179, x180, x181, x182, x183, x184, x185, x186, x187, x188);
