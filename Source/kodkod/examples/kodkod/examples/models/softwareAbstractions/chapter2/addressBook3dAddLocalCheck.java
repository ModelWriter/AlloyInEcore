...
public final class addressBook3dAddLocalCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> atomlist = Arrays.asList(
                ...
                "-6", "-7", "-8", "0", "1", "2",
                "3", "4", "5", "6", "7", "Book$0",
                "Book$1", "BookOrder/Ord$0", "Target$0", "Target$1", "Target$2"
        );
        ...
        Formula x19=x20.no();
        Variable x24=Variable.unary("addLocal_this");
        ...
        Variable x32=Variable.unary("addLocal_this");
        ...
        Variable x58=Variable.unary("addLocal_this");
        Decls x57=x58.oneOf(x9);
        Variable x62=Variable.unary("addLocal_n");
        ...
        Variable x70=Variable.unary("addLocal_a");
        ...
        Variable x130=Variable.unary("addLocal_b");
        Decls x129=x130.oneOf(x9);
        Variable x132=Variable.unary("addLocal_b'");
        Decls x131=x132.oneOf(x9);
        Variable x134=Variable.unary("addLocal_n");
        Decls x133=x134.oneOf(x21);
        Variable x136=Variable.unary("addLocal_n'");
        Decls x135=x136.oneOf(x21);
        Variable x138=Variable.unary("addLocal_t");
        ...
        Expression x155=x134.product(x138);
        Expression x153=x154.union(x155);
        Formula x151=x152.eq(x153);
        Formula x142=x143.and(x151);
        Formula x157=x134.eq(x136);
        Formula x156=x157.not();
        Formula x141=x142.and(x156);
        Formula x140=x141.not();
        Expression x162=x130.join(x12);
        Expression x161=x162.closure();
        Expression x160=x136.join(x161);
        Expression x159=x160.intersection(x6);
        Expression x166=x132.join(x12);
        Expression x165=x166.closure();
        Expression x164=x136.join(x165);
        Expression x163=x164.intersection(x6);
        Formula x158=x159.eq(x163);
        Formula x139=x140.or(x158);
        Formula x127=x139.forAll(x128);
        Formula x126=x127.not();
        Formula x167=x0.eq(x0);
        Formula x168=x1.eq(x1);
        Formula x169=x2.eq(x2);
        Formula x170=x3.eq(x3);
        Formula x171=x4.eq(x4);
        Formula x172=x5.eq(x5);
        Formula x173=x6.eq(x6);
        Formula x174=x7.eq(x7);
        Formula x175=x8.eq(x8);
        Formula x176=x9.eq(x9);
        Formula x177=x10.eq(x10);
        Formula x178=x11.eq(x11);
        Formula x179=x12.eq(x12);
        Formula x180=x13.eq(x13);
        Formula x181=x14.eq(x14);
        Formula x182=x15.eq(x15);
