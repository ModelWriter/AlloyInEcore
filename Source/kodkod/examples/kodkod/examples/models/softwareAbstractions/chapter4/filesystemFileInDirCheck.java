...
public final class filesystemFileInDirCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x11=x12.no();
        Variable x16=Variable.unary("FileInDir_this");
        ...
        Variable x36=Variable.unary("FileInDir_f");
        Decls x35=x36.oneOf(x8);
        Expression x38=x9.join(x36);
        Formula x37=x38.some();
        Formula x34=x37.forAll(x35);
        Formula x33=x34.not();
        Formula x39=x0.eq(x0);
        Formula x40=x1.eq(x1);
        Formula x41=x2.eq(x2);
        Formula x42=x3.eq(x3);
        Formula x43=x4.eq(x4);
        Formula x44=x5.eq(x5);
        Formula x45=x6.eq(x6);
        Formula x46=x7.eq(x7);
        Formula x47=x8.eq(x8);
        Formula x48=x9.eq(x9);
