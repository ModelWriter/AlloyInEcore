...
public final class filesystemSomeDirCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x11=x12.no();
        Variable x16=Variable.unary("SomeDir_this");
        ...
        Variable x36=Variable.unary("SomeDir_o");
        Expression x37=x19.difference(x6);
        Decls x35=x36.oneOf(x37);
        Expression x39=x9.join(x36);
        Formula x38=x39.some();
