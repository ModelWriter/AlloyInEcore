...
public final class grandpa3NoSelfFatherCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x13=x14.no();
        Variable x17=Variable.unary("NoSelfFather_this");
        ...
        Variable x27=Variable.unary("NoSelfFather_this");
        ...
        Variable x36=Variable.unary("NoSelfFather_this");
        ...
        Variable x46=Variable.unary("NoSelfFather_this");
        ...
        Variable x55=Variable.unary("NoSelfFather_p");
        ...
        Formula x63=x64.no();
        Variable x71=Variable.unary("NoSelfFather_m");
        Decls x70=x71.oneOf(x6);
        Expression x74=x71.join(x8);
        Formula x73=x71.eq(x74);
        Formula x72=x73.not();
        ...
        Formula x12=Formula.compose(FormulaOperator.AND, x13, x15, x22, x25, x32, x34, x42, x44, x51, x53, x61, x63, x68, x75, x76, x77, x78, x79, x80, x81, x82, x83, x84, x85, x86);
