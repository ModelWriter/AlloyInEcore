...
public final class abstractMemoryWriteReadCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x13=Variable.unary("WriteRead_this");
        ...
        Variable x38=Variable.unary("WriteRead_m");
        Decls x37=x38.oneOf(x8);
        Variable x40=Variable.unary("WriteRead_m'");
        ...
        Variable x52=Variable.unary("WriteRead_m");
        Decls x51=x52.oneOf(x8);
        Variable x54=Variable.unary("WriteRead_m'");
        Decls x53=x54.oneOf(x8);
        Variable x56=Variable.unary("WriteRead_a");
        Decls x55=x56.oneOf(x6);
        Variable x58=Variable.unary("WriteRead_d1");
        Decls x57=x58.oneOf(x7);
        Variable x60=Variable.unary("WriteRead_d2");
        Decls x59=x60.oneOf(x7);
        Decls x50=x51.and(x53).and(x55).and(x57).and(x59);
        Expression x65=x54.join(x9);
        Expression x67=x52.join(x9);
        Expression x68=x56.product(x58);
        Expression x66=x67.override(x68);
        Formula x64=x65.eq(x66);
        Expression x73=x54.join(x9);
        Expression x72=x56.join(x73);
        Formula x71=x72.some();
        Formula x70=x71.not();
        Formula x74=x60.eq(x72);
        Formula x69=x70.or(x74);
        Formula x63=x64.and(x69);
        Formula x62=x63.not();
        Formula x75=x58.eq(x60);
        Formula x61=x62.or(x75);
