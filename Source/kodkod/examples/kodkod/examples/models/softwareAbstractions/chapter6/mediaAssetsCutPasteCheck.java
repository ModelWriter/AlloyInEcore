...
public final class mediaAssetsCutPasteCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x22=Variable.unary("CutPaste_this");
        ...
        Variable x30=Variable.unary("CutPaste_this");
        ...
        Variable x55=Variable.unary("CutPaste_this");
        ...
        Variable x65=Variable.unary("CutPaste_this");
        ...
        Variable x72=Variable.unary("CutPaste_this");
        ...
        Variable x79=Variable.unary("CutPaste_this");
        ...
        Variable x87=Variable.unary("CutPaste_this");
        ...
        Formula x93=x94.no();
        Variable x97=Variable.unary("CutPaste_this");
        ...
        Variable x106=Variable.unary("CutPaste_this");
        ...
        Variable x116=Variable.unary("CutPaste_xs");
        Decls x115=x116.oneOf(x6);
        Variable x118=Variable.unary("CutPaste_xs'");
        Decls x117=x118.oneOf(x6);
        Variable x120=Variable.unary("CutPaste_xs");
        ...
        Expression x148=x116.join(x13);
        Expression x149=x116.join(x12);
        Expression x147=x148.join(x149);
        Expression x146=x147.join(x18);
        Formula x145=x146.eq(x10);
        Formula x144=x145.not();
        Expression x151=x118.join(x14);
        Formula x150=x151.eq(x146);
        Formula x143=x144.and(x150);
        Variable x154=Variable.unary("cut_cs'");
        Decls x153=x154.oneOf(x9);
        Expression x158=x154.join(x15);
        Expression x160=x147.join(x15);
        Expression x159=x160.difference(x146);
        Formula x157=x158.eq(x159);
        Expression x163=x154.join(x17);
        Expression x165=x147.join(x17);
        Expression x164=x165.difference(x146);
        Formula x162=x163.eq(x164);
        Expression x167=x118.join(x12);
        Expression x169=x116.join(x12);
        Expression x171=x116.join(x13);
        Expression x170=x171.product(x154);
        Expression x168=x169.override(x170);
        Formula x166=x167.eq(x168);
        Formula x161=x162.and(x166);
        Formula x156=x157.and(x161);
        Expression x173=x154.join(x18);
        Formula x172=x173.eq(x10);
        Formula x155=x156.and(x172);
        Formula x152=x155.forSome(x153);
        Formula x142=x143.and(x152);
        Expression x175=x118.join(x11);
        Expression x176=x116.join(x11);
        Formula x174=x175.eq(x176);
        Formula x141=x142.and(x174);
        Expression x178=x118.join(x13);
        Expression x179=x116.join(x13);
        Formula x177=x178.eq(x179);
        Formula x140=x141.and(x177);
        Formula x124=x125.and(x140);
        Expression x184=x120.join(x14);
        Expression x185=x118.join(x14);
        Formula x183=x184.eq(x185);
        Variable x188=Variable.unary("paste_cs'");
        Decls x187=x188.oneOf(x9);
        Expression x192=x188.join(x15);
        Expression x196=x118.join(x13);
        Expression x197=x118.join(x12);
        Expression x195=x196.join(x197);
        Expression x194=x195.join(x15);
        Expression x193=x194.union(x185);
        Formula x191=x192.eq(x193);
        Expression x200=x188.join(x17);
        Expression x202=x195.join(x17);
        Expression x204=x195.join(x15);
        Expression x203=x185.difference(x204);
        Expression x201=x202.union(x203);
        Formula x199=x200.eq(x201);
        Expression x206=x120.join(x12);
        Expression x208=x118.join(x12);
        Expression x210=x118.join(x13);
        Expression x209=x210.product(x188);
        Expression x207=x208.override(x209);
        Formula x205=x206.eq(x207);
        Formula x198=x199.and(x205);
        Formula x190=x191.and(x198);
        Expression x212=x188.join(x18);
        Expression x214=x195.join(x15);
        Expression x213=x185.difference(x214);
        Formula x211=x212.eq(x213);
        Formula x189=x190.and(x211);
        Formula x186=x189.forSome(x187);
        Formula x182=x183.and(x186);
        Expression x216=x120.join(x11);
        Expression x217=x118.join(x11);
        Formula x215=x216.eq(x217);
        Formula x181=x182.and(x215);
        Expression x219=x120.join(x13);
        Expression x220=x118.join(x13);
        Formula x218=x219.eq(x220);
        Formula x180=x181.and(x218);
        Formula x123=x124.and(x180);
