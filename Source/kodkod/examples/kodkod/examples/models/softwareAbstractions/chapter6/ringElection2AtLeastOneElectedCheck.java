...
public final class ringElection2AtLeastOneElectedCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x22=Variable.unary("AtLeastOneElected_this");
        ...
        Variable x32=Variable.unary("AtLeastOneElected_this");
        ...
        Variable x41=Variable.unary("AtLeastOneElected_this");
        ...
        Variable x64=Variable.unary("AtLeastOneElected_p");
        ...
        Formula x68=x69.no();
        Variable x72=Variable.unary("AtLeastOneElected_t");
        Expression x73=x6.difference(x13);
        Decls x71=x72.oneOf(x73);
        Expression x75=x12.join(x72);
        Variable x78=Variable.unary("AtLeastOneElected_p");
        ...
        Variable x158=Variable.unary("progress_t");
        Expression x159=x6.difference(x97);
        Decls x157=x158.oneOf(x159);
        Expression x164=x7.join(x11);
        Expression x163=x164.join(x158);
        Formula x162=x163.some();
        Formula x161=x162.not();
        Variable x167=Variable.unary("progress_p");
        Decls x166=x167.oneOf(x7);
        Expression x171=x167.join(x11);
        Expression x170=x171.join(x158);
        Expression x173=x167.join(x11);
        Expression x174=x158.join(x14);
        Expression x172=x173.join(x174);
        Formula x169=x170.eq(x172);
        Formula x168=x169.not();
        Formula x165=x168.forSome(x166);
        Formula x160=x161.or(x165);
        Formula x156=x160.forAll(x157);
        Formula x155=x156.not();
        Expression x176=x12.join(x6);
        Formula x175=x176.some();
        Formula x154=x155.or(x175);
        ...
        Formula x193=x16.eq(x16);
        Formula x194=x17.eq(x17);
        Formula x195=x18.eq(x18);
