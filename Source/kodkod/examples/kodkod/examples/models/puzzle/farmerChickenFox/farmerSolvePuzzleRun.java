...
public final class farmerSolvePuzzleRun
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x24=x25.no();
        Variable x29=Variable.unary("solvePuzzle_this");
        ...
        Variable x38=Variable.unary("solvePuzzle_this");
        ...
        Variable x45=Variable.unary("solvePuzzle_this");
        ...
        Variable x70=Variable.unary("solvePuzzle_s");
        Decls x69=x70.oneOf(x10);
        Variable x72=Variable.unary("solvePuzzle_s'");
        ...
        Expression x135=x16.join(x10);
        Expression x134=x10.difference(x135);
        Expression x133=x134.join(x14);
        Formula x132=x133.eq(x30);
        Formula x136=x0.eq(x0);
        Formula x137=x1.eq(x1);
        Formula x138=x2.eq(x2);
        Formula x139=x3.eq(x3);
        Formula x140=x4.eq(x4);
        Formula x141=x5.eq(x5);
        Formula x142=x6.eq(x6);
        Formula x143=x7.eq(x7);
        Formula x144=x8.eq(x8);
        Formula x145=x9.eq(x9);
        Formula x146=x10.eq(x10);
        Formula x147=x11.eq(x11);
        Formula x148=x12.eq(x12);
        Formula x149=x13.eq(x13);
        Formula x150=x14.eq(x14);
        Formula x151=x15.eq(x15);
        Formula x152=x16.eq(x16);
        Formula x153=x17.eq(x17);
        Formula x18=Formula.compose(FormulaOperator.AND, x19, x21, x24, x27, x33, x36, x41, x43, x48, x50, x53, x57, x58, x62, x67, x132, x136, x137, x138, x139, x140, x141, x142, x143, x144, x145, x146, x147, x148, x149, x150, x151, x152, x153);
