...
public final class prisonerTypeOKCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x32=x33.no();
        Variable x36=Variable.unary("TypeOK_this");
        ...
        Variable x47=Variable.unary("TypeOK_this");
        ...
        Variable x72=Variable.unary("TypeOK_this");
        ...
        Variable x82=Variable.unary("TypeOK_this");
        ...
        Variable x105=Variable.unary("TypeOK_this");
        ...
        Variable x158=Variable.unary("TypeOK_s");
        Decls x157=x158.oneOf(x15);
        Variable x160=Variable.unary("TypeOK_s'");
        Expression x161=x158.join(x23);
        Decls x159=x160.oneOf(x161);
        Decls x156=x157.and(x159);
        Variable x166=Variable.unary("TypeOK_p");
        ...
        Variable x257=Variable.unary("TypeOK_p");
        ...
        Variable x356=Variable.unary("TypeOK_s");
        Decls x355=x356.oneOf(x15);
        Expression x361=x356.join(x19);
        IntExpression x360=x361.sum();
        IntExpression x362=IntConstant.constant(0);
        Formula x359=x360.gte(x362);
        Expression x365=x356.join(x19);
        IntExpression x364=x365.sum();
        IntExpression x367=IntConstant.constant(2);
        IntExpression x369=x111.count();
        IntExpression x370=IntConstant.constant(1);
        IntExpression x368=x369.minus(x370);
        IntExpression x366=x367.multiply(x368);
        Formula x363=x364.lte(x366);
        Formula x358=x359.and(x363);
        Variable x373=Variable.unary("TypeOK_p");
        Decls x372=x373.oneOf(x6);
        Expression x377=x356.join(x20);
        Expression x376=x373.join(x377);
        IntExpression x375=x376.sum();
        IntExpression x378=IntConstant.constant(2);
        Formula x374=x375.lte(x378);
        Formula x371=x374.forAll(x372);
        Formula x357=x358.and(x371);
        Formula x354=x357.forAll(x355);
        Formula x353=x354.not();
        Formula x379=x0.eq(x0);
        Formula x380=x1.eq(x1);
        Formula x381=x2.eq(x2);
        Formula x382=x3.eq(x3);
        Formula x383=x4.eq(x4);
        Formula x384=x5.eq(x5);
        Formula x385=x6.eq(x6);
        Formula x386=x7.eq(x7);
        Formula x387=x8.eq(x8);
        Formula x388=x9.eq(x9);
        Formula x389=x10.eq(x10);
        Formula x390=x11.eq(x11);
        Formula x391=x12.eq(x12);
        Formula x392=x13.eq(x13);
        Formula x393=x14.eq(x14);
        Formula x394=x15.eq(x15);
        Formula x395=x16.eq(x16);
        Formula x396=x17.eq(x17);
        Formula x397=x18.eq(x18);
        Formula x398=x19.eq(x19);
        Formula x399=x20.eq(x20);
        Formula x400=x21.eq(x21);
        Formula x401=x22.eq(x22);
        Formula x402=x23.eq(x23);
        Formula x403=x24.eq(x24);
        Formula x25=Formula.compose(FormulaOperator.AND, x26, x28, x30, x32, x34, x42, x45, x67, x70, x78, x80, x100, x103, x112, x114, x117, x121, x122, x124, x127, x129, x137, x141, x151, x153, x155, x353, x379, x380, x381, x382, x383, x384, x385, x386, x387, x388, x389, x390, x391, x392, x393, x394, x395, x396, x397, x398, x399, x400, x401, x402, x403);
