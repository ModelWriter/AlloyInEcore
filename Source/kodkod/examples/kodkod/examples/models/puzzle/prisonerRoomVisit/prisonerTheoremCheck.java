...
public final class prisonerTheoremCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x32=x33.no();
        Variable x36=Variable.unary("Theorem_this");
        ...
        Variable x47=Variable.unary("Theorem_this");
        ...
        Variable x72=Variable.unary("Theorem_this");
        ...
        Variable x82=Variable.unary("Theorem_this");
        ...
        Variable x105=Variable.unary("Theorem_this");
        ...
        Variable x158=Variable.unary("Theorem_s");
        Decls x157=x158.oneOf(x15);
        Variable x160=Variable.unary("Theorem_s'");
        Expression x161=x158.join(x23);
        Decls x159=x160.oneOf(x161);
        Decls x156=x157.and(x159);
        Variable x166=Variable.unary("Theorem_p");
        ...
        Variable x257=Variable.unary("Theorem_p");
        ...
        Variable x359=Variable.unary("Fairness_p");
        Decls x358=x359.oneOf(x6);
        Variable x363=Variable.unary("Fairness_s");
        Decls x362=x363.oneOf(x15);
        Variable x365=Variable.unary("Fairness_s'");
        Decls x364=x365.oneOf(x15);
        Decls x361=x362.and(x364);
        Expression x370=x23.closure();
        Expression x369=x363.join(x370);
        Formula x368=x365.in(x369);
        Expression x373=x363.join(x21);
        Formula x372=x373.eq(x7);
        Expression x376=x363.join(x23);
        Expression x375=x376.join(x21);
        Formula x374=x375.eq(x359);
        Formula x371=x372.and(x374);
        Formula x367=x368.and(x371);
        Expression x379=x365.join(x21);
        Formula x378=x379.eq(x7);
        Expression x382=x365.join(x23);
        Expression x381=x382.join(x21);
        Formula x380=x381.eq(x359);
        Formula x377=x378.and(x380);
        Formula x366=x367.and(x377);
        Formula x360=x366.forSome(x361);
        Formula x357=x360.forAll(x358);
        Variable x385=Variable.unary("AfterNonCounterPlayerEventaullyCounterPlayertEnterTheRoom_s");
        Decls x384=x385.oneOf(x15);
        Expression x389=x385.join(x21);
        Formula x388=x389.in(x6);
        Formula x387=x388.not();
        Variable x392=Variable.unary("AfterNonCounterPlayerEventaullyCounterPlayertEnterTheRoom_s'");
        Expression x394=x23.closure();
        Expression x393=x385.join(x394);
        Decls x391=x392.oneOf(x393);
        Expression x396=x392.join(x21);
        Formula x395=x396.eq(x7);
        Formula x390=x395.forSome(x391);
        Formula x386=x387.or(x390);
        Formula x383=x386.forAll(x384);
        Formula x356=x357.and(x383);
        Formula x355=x356.not();
        Variable x399=Variable.unary("Done_s");
        Decls x398=x399.oneOf(x15);
        Expression x401=x399.join(x17);
        Formula x400=x401.eq(x9);
        Formula x397=x400.forSome(x398);
        Formula x354=x355.or(x397);
        Formula x353=x354.not();
        Formula x402=x0.eq(x0);
        Formula x403=x1.eq(x1);
        Formula x404=x2.eq(x2);
        Formula x405=x3.eq(x3);
        Formula x406=x4.eq(x4);
        Formula x407=x5.eq(x5);
        Formula x408=x6.eq(x6);
        Formula x409=x7.eq(x7);
        Formula x410=x8.eq(x8);
        Formula x411=x9.eq(x9);
        Formula x412=x10.eq(x10);
        Formula x413=x11.eq(x11);
        Formula x414=x12.eq(x12);
        Formula x415=x13.eq(x13);
        Formula x416=x14.eq(x14);
        Formula x417=x15.eq(x15);
        Formula x418=x16.eq(x16);
        Formula x419=x17.eq(x17);
        Formula x420=x18.eq(x18);
        Formula x421=x19.eq(x19);
        Formula x422=x20.eq(x20);
        Formula x423=x21.eq(x21);
        Formula x424=x22.eq(x22);
        Formula x425=x23.eq(x23);
        Formula x426=x24.eq(x24);
