...
public final class prisonerCountInvariantCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x32=x33.no();
        Variable x36=Variable.unary("CountInvariant_this");
        ...
        Variable x47=Variable.unary("CountInvariant_this");
        ...
        Variable x72=Variable.unary("CountInvariant_this");
        ...
        Variable x82=Variable.unary("CountInvariant_this");
        ...
        Variable x105=Variable.unary("CountInvariant_this");
        ...
        Variable x158=Variable.unary("CountInvariant_s");
        Decls x157=x158.oneOf(x15);
        Variable x160=Variable.unary("CountInvariant_s'");
        Expression x161=x158.join(x23);
        Decls x159=x160.oneOf(x161);
        Decls x156=x157.and(x159);
        Variable x166=Variable.unary("CountInvariant_p");
        ...
        Variable x257=Variable.unary("CountInvariant_p");
        ...
        Variable x356=Variable.unary("CountInvariant_s");
        Decls x355=x356.oneOf(x15);
        Expression x361=x356.join(x18);
        Expression x360=x11.join(x361);
        Formula x359=x360.eq(x13);
        Expression x365=x356.join(x19);
        IntExpression x364=x365.sum();
        Variable x369=Variable.unary("CountInvariant_p");
        Decls x368=x369.oneOf(x6);
        Expression x372=x356.join(x20);
        Expression x371=x369.join(x372);
        IntExpression x370=x371.sum();
        IntExpression x367=x370.sum(x368);
        IntExpression x373=IntConstant.constant(1);
        IntExpression x366=x367.minus(x373);
        Formula x363=x364.eq(x366);
        Expression x376=x356.join(x19);
        IntExpression x375=x376.sum();
        Formula x374=x375.eq(x367);
        Formula x362=x363.or(x374);
        Formula x358=x359.implies(x362);
        Formula x378=x359.not();
        Expression x382=x356.join(x19);
        IntExpression x381=x382.sum();
        Formula x380=x381.eq(x367);
        Expression x385=x356.join(x19);
        IntExpression x384=x385.sum();
        IntExpression x387=IntConstant.constant(1);
        IntExpression x386=x367.plus(x387);
        Formula x383=x384.eq(x386);
        Formula x379=x380.or(x383);
        Formula x377=x378.implies(x379);
        Formula x357=x358.and(x377);
        Formula x354=x357.forAll(x355);
        Formula x353=x354.not();
        Formula x388=x0.eq(x0);
        Formula x389=x1.eq(x1);
        Formula x390=x2.eq(x2);
        Formula x391=x3.eq(x3);
        Formula x392=x4.eq(x4);
        Formula x393=x5.eq(x5);
        Formula x394=x6.eq(x6);
        Formula x395=x7.eq(x7);
        Formula x396=x8.eq(x8);
        Formula x397=x9.eq(x9);
        Formula x398=x10.eq(x10);
        Formula x399=x11.eq(x11);
        Formula x400=x12.eq(x12);
        Formula x401=x13.eq(x13);
        Formula x402=x14.eq(x14);
        Formula x403=x15.eq(x15);
        Formula x404=x16.eq(x16);
        Formula x405=x17.eq(x17);
        Formula x406=x18.eq(x18);
        Formula x407=x19.eq(x19);
        Formula x408=x20.eq(x20);
        Formula x409=x21.eq(x21);
        Formula x410=x22.eq(x22);
        Formula x411=x23.eq(x23);
        Formula x412=x24.eq(x24);
        Formula x25=Formula.compose(FormulaOperator.AND, x26, x28, x30, x32, x34, x42, x45, x67, x70, x78, x80, x100, x103, x112, x114, x117, x121, x122, x124, x127, x129, x137, x141, x151, x153, x155, x353, x388, x389, x390, x391, x392, x393, x394, x395, x396, x397, x398, x399, x400, x401, x402, x403, x404, x405, x406, x407, x408, x409, x410, x411, x412);
