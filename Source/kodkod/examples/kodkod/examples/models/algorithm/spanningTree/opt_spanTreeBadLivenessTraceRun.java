...
public final class opt_spanTreeBadLivenessTraceRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x25=Variable.unary("BadLivenessTrace_this");
        ...
        Variable x34=Variable.unary("BadLivenessTrace_this");
        ...
        Variable x41=Variable.unary("BadLivenessTrace_this");
        ...
        Variable x64=Variable.unary("BadLivenessTrace_this");
        ...
        Variable x123=Variable.unary("BadLivenessTrace_s");
        ...
        Variable x131=Variable.unary("BadLivenessTrace_p");
        ...
        Variable x146=Variable.unary("BadLivenessTrace_p");
        ...
        Variable x165=Variable.unary("BadLivenessTrace_s");
        Expression x166=x9.difference(x125);
        Decls x164=x165.oneOf(x166);
        Variable x169=Variable.unary("BadLivenessTrace_p");
        ...
        Variable x235=Variable.unary("BadLivenessTrace_s");
        Decls x234=x235.oneOf(x9);
        Variable x237=Variable.unary("BadLivenessTrace_s'");
        Decls x236=x237.oneOf(x9);
        Decls x233=x234.and(x236);
        Formula x240=x235.eq(x237);
        Formula x239=x240.not();
        Expression x243=x235.join(x14);
        Expression x244=x237.join(x14);
        Formula x242=x243.eq(x244);
        Expression x246=x235.join(x15);
        Expression x247=x237.join(x15);
        Formula x245=x246.eq(x247);
        Formula x241=x242.and(x245);
        Formula x238=x239.and(x241);
        Formula x232=x238.forSome(x233);
        Variable x250=Variable.unary("BadLivenessTrace_s");
        Decls x249=x250.oneOf(x9);
        Expression x258=x250.join(x15);
        Expression x257=x258.transpose();
        Expression x256=x257.closure();
        Expression x260=x106.product(Expression.UNIV);
        Expression x259=Expression.IDEN.intersection(x260);
        Expression x255=x256.union(x259);
        Expression x254=x6.join(x255);
        Formula x253=x26.in(x254);
        Variable x263=Variable.unary("acyclic_x");
        Decls x262=x263.oneOf(x26);
        Expression x269=x250.join(x15);
        Expression x268=x269.transpose();
        Expression x267=x268.closure();
        Expression x266=x263.join(x267);
        Formula x265=x263.in(x266);
        Formula x264=x265.not();
        Formula x261=x264.forAll(x262);
        Formula x252=x253.and(x261);
        Formula x251=x252.not();
        Formula x248=x251.forAll(x249);
        Formula x270=x0.eq(x0);
        Formula x271=x1.eq(x1);
        Formula x272=x2.eq(x2);
        Formula x273=x3.eq(x3);
        Formula x274=x4.eq(x4);
        Formula x275=x5.eq(x5);
        Formula x276=x6.eq(x6);
        Formula x277=x7.eq(x7);
        Formula x278=x8.eq(x8);
        Formula x279=x9.eq(x9);
        Formula x280=x10.eq(x10);
        Formula x281=x11.eq(x11);
        Formula x282=x12.eq(x12);
        Formula x283=x13.eq(x13);
        Formula x284=x14.eq(x14);
        Formula x285=x15.eq(x15);
        Formula x286=x16.eq(x16);
        Formula x287=x17.eq(x17);
        Formula x288=x18.eq(x18);
        Formula x289=x19.eq(x19);
        Formula x290=x20.eq(x20);
        Formula x291=x21.eq(x21);
        Formula x22=Formula.compose(FormulaOperator.AND, x23, x29, x32, x37, x39, x59, x62, x82, x85, x88, x92, x93, x96, x100, x101, x113, x115, x121, x158, x163, x232, x248, x270, x271, x272, x273, x274, x275, x276, x277, x278, x279, x280, x281, x282, x283, x284, x285, x286, x287, x288, x289, x290, x291);
