...
public final class opt_spanTreeSuccessfulRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> atomlist = Arrays.asList(
                ...
                "-6", "-7", "-8", "0", "1", "2",
                "3", "4", "5", "6", "7", "Lvl$0",
                "Lvl$1", "Lvl$2", "Process$0", "Process$1", "Process$2", "Process$3",
                "Root$0", "State$0", "State$1", "State$2", "State$3", "lo/Ord$0",
                "so/Ord$0"
        );
        ...
        Variable x25=Variable.unary("SuccessfulRun_this");
        ...
        Variable x34=Variable.unary("SuccessfulRun_this");
        ...
        Variable x41=Variable.unary("SuccessfulRun_this");
        ...
        Variable x64=Variable.unary("SuccessfulRun_this");
        ...
        Variable x123=Variable.unary("SuccessfulRun_s");
        ...
        Variable x146=Variable.unary("SuccessfulRun_p");
        ...
        Variable x165=Variable.unary("SuccessfulRun_s");
        Expression x166=x9.difference(x125);
        Decls x164=x165.oneOf(x166);
        Variable x169=Variable.unary("SuccessfulRun_p");
        ...
        Expression x238=x125.join(x15);
        Expression x237=x238.transpose();
        Expression x236=x237.closure();
        Expression x240=x106.product(Expression.UNIV);
        Expression x239=Expression.IDEN.intersection(x240);
        Expression x235=x236.union(x239);
        Expression x234=x6.join(x235);
        Formula x233=x26.in(x234);
        Variable x243=Variable.unary("acyclic_x");
        Decls x242=x243.oneOf(x26);
        Expression x249=x125.join(x15);
        Expression x248=x249.transpose();
        Expression x247=x248.closure();
        Expression x246=x243.join(x247);
        Formula x245=x243.in(x246);
        Formula x244=x245.not();
        Formula x241=x244.forAll(x242);
        Formula x232=x233.and(x241);
        Variable x252=Variable.unary("SuccessfulRun_s");
        Expression x253=x9.difference(x125);
        Decls x251=x252.oneOf(x253);
        Expression x261=x252.join(x15);
        Expression x260=x261.transpose();
        Expression x259=x260.closure();
        Expression x263=x106.product(Expression.UNIV);
        Expression x262=Expression.IDEN.intersection(x263);
        Expression x258=x259.union(x262);
        Expression x257=x6.join(x258);
        Formula x256=x26.in(x257);
        Variable x266=Variable.unary("acyclic_x");
        Decls x265=x266.oneOf(x26);
        Expression x272=x252.join(x15);
        Expression x271=x272.transpose();
        Expression x270=x271.closure();
        Expression x269=x266.join(x270);
        Formula x268=x266.in(x269);
        Formula x267=x268.not();
        Formula x264=x267.forAll(x265);
        Formula x255=x256.and(x264);
        Formula x254=x255.not();
        Formula x250=x254.forAll(x251);
        Formula x273=x0.eq(x0);
        Formula x274=x1.eq(x1);
        Formula x275=x2.eq(x2);
        Formula x276=x3.eq(x3);
        Formula x277=x4.eq(x4);
        Formula x278=x5.eq(x5);
        Formula x279=x6.eq(x6);
        Formula x280=x7.eq(x7);
        Formula x281=x8.eq(x8);
        Formula x282=x9.eq(x9);
        Formula x283=x10.eq(x10);
        Formula x284=x11.eq(x11);
        Formula x285=x12.eq(x12);
        Formula x286=x13.eq(x13);
        Formula x287=x14.eq(x14);
        Formula x288=x15.eq(x15);
        Formula x289=x16.eq(x16);
        Formula x290=x17.eq(x17);
        Formula x291=x18.eq(x18);
        Formula x292=x19.eq(x19);
        Formula x293=x20.eq(x20);
        Formula x294=x21.eq(x21);
