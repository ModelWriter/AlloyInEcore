...
public final class marksweepgcCompletenessCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x15=Variable.unary("Completeness_this");
        ...
        Variable x39=Variable.unary("Completeness_this");
        ...
        Variable x62=Variable.unary("Completeness_this");
        ...
        Variable x69=Variable.unary("Completeness_this");
        ...
        Variable x80=Variable.unary("Completeness_h");
        Decls x79=x80.oneOf(x7);
        Variable x82=Variable.unary("Completeness_h'");
        Decls x81=x82.oneOf(x7);
        Variable x84=Variable.unary("Completeness_root");
        ...
        Formula x86=x87.not();
        Expression x191=x82.join(x8);
        Expression x192=x82.join(x9);
        Expression x190=x191.union(x192);
        Expression x189=x190.closure();
        Expression x188=x84.join(x189);
        Expression x187=x84.union(x188);
        Expression x186=x6.difference(x187);
        Expression x194=x82.join(x11);
        Expression x198=x82.join(x8);
        Expression x199=x82.join(x9);
        Expression x197=x198.union(x199);
        Expression x196=x197.closure();
        Expression x195=x194.join(x196);
        Expression x193=x194.union(x195);
        Formula x185=x186.in(x193);
        Formula x85=x86.or(x185);
        Formula x77=x85.forAll(x78);
        Formula x76=x77.not();
        Formula x200=x0.eq(x0);
        Formula x201=x1.eq(x1);
        Formula x202=x2.eq(x2);
        Formula x203=x3.eq(x3);
        Formula x204=x4.eq(x4);
        Formula x205=x5.eq(x5);
        Formula x206=x6.eq(x6);
        Formula x207=x7.eq(x7);
        Formula x208=x8.eq(x8);
        Formula x209=x9.eq(x9);
        Formula x210=x10.eq(x10);
        Formula x211=x11.eq(x11);
        Formula x12=Formula.compose(FormulaOperator.AND, x13, x33, x37, x57, x60, x65, x67, x74, x76, x200, x201, x202, x203, x204, x205, x206, x207, x208, x209, x210, x211);
