...
public final class marksweepgcSoundness2Check {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x15=Variable.unary("Soundness2_this");
        ...
        Variable x39=Variable.unary("Soundness2_this");
        ...
        Variable x62=Variable.unary("Soundness2_this");
        ...
        Variable x69=Variable.unary("Soundness2_this");
        ...
        Variable x80=Variable.unary("Soundness2_h");
        Decls x79=x80.oneOf(x7);
        Variable x82=Variable.unary("Soundness2_h'");
        Decls x81=x82.oneOf(x7);
        Variable x84=Variable.unary("Soundness2_root");
        ...
        Expression x186=x187.intersection(x193);
        Formula x185=x186.no();
