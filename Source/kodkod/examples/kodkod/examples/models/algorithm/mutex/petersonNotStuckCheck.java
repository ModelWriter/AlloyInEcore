...
public final class petersonNotStuckCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x35=x36.no();
        Variable x40=Variable.unary("NotStuck_this");
        ...
        Variable x51=Variable.unary("NotStuck_this");
        ...
        Variable x60=Variable.unary("NotStuck_this");
        ...
        Variable x69=Variable.unary("NotStuck_this");
        ...
        Variable x101=Variable.unary("NotStuck_i");
        ...
        Variable x115=Variable.unary("NotStuck_pre");
        ...
        Variable x122=Variable.unary("NotStuck_i");
        ...
        Variable x312=Variable.unary("NotStuck_i");
        ...
        Variable x333=Variable.unary("NotStuck_i");
        ...
        Variable x380=Variable.unary("NotStuck_pre");
        Expression x381=x13.difference(x117);
        Decls x379=x380.oneOf(x381);
        Variable x384=Variable.unary("NotStuck_i");
        Decls x383=x384.oneOf(x6);
        Expression x392=x380.join(x16);
        Expression x391=x384.join(x392);
        Formula x390=x391.eq(x8);
        Expression x398=x380.join(x23);
        Expression x397=x398.join(x19);
        Expression x396=x384.join(x397);
        Expression x399=x20.join(x21);
        Formula x395=x396.eq(x399);
        Expression x402=x398.join(x17);
        Expression x401=x384.join(x402);
        Expression x404=x380.join(x17);
        Expression x403=x384.join(x404);
        Formula x400=x401.eq(x403);
        Formula x394=x395.and(x400);
        Expression x406=x398.join(x18);
        Expression x407=x380.join(x18);
        Formula x405=x406.eq(x407);
        Formula x393=x394.and(x405);
        Formula x389=x390.and(x393);
        Expression x410=x398.join(x16);
        Expression x409=x384.join(x410);
        Formula x408=x409.eq(x9);
        Formula x388=x389.and(x408);
        Expression x417=x380.join(x16);
        Expression x416=x384.join(x417);
        Formula x415=x416.eq(x9);
        Expression x422=x398.join(x19);
        Expression x421=x384.join(x422);
        Expression x424=x380.join(x19);
        Expression x423=x384.join(x424);
        Formula x420=x421.eq(x423);
        Expression x427=x398.join(x16);
        Expression x426=x384.join(x427);
        Formula x425=x426.eq(x10);
        Formula x419=x420.and(x425);
        Expression x429=x398.join(x18);
        Expression x430=x380.join(x18);
        Formula x428=x429.eq(x430);
        Formula x418=x419.and(x428);
        Formula x414=x415.and(x418);
        Expression x433=x398.join(x17);
        Expression x432=x384.join(x433);
        Expression x435=x380.join(x19);
        Expression x434=x384.join(x435);
        Formula x431=x432.eq(x434);
        Formula x413=x414.and(x431);
        Expression x441=x380.join(x16);
        Expression x440=x384.join(x441);
        Formula x439=x440.eq(x11);
        Variable x444=Variable.unary("L3TransPre_k");
        Expression x445=x6.difference(x384);
        Decls x443=x444.oneOf(x445);
        Expression x449=x380.join(x17);
        Expression x448=x444.join(x449);
        Expression x452=x380.join(x19);
        Expression x451=x384.join(x452);
        Expression x454=x21.transpose();
        Expression x453=x454.closure();
        Expression x450=x451.join(x453);
        Formula x447=x448.in(x450);
        Expression x459=x380.join(x19);
        Expression x458=x384.join(x459);
        Expression x460=x380.join(x18);
        Expression x457=x458.join(x460);
        Formula x456=x457.eq(x384);
        Formula x455=x456.not();
        Formula x446=x447.or(x455);
        Formula x442=x446.forAll(x443);
        Formula x438=x439.and(x442);
        Expression x465=x398.join(x19);
        Expression x464=x384.join(x465);
        Expression x468=x380.join(x19);
        Expression x467=x384.join(x468);
        Expression x466=x467.join(x21);
        Formula x463=x464.eq(x466);
        Expression x471=x398.join(x17);
        Expression x470=x384.join(x471);
        Expression x473=x380.join(x17);
        Expression x472=x384.join(x473);
        Formula x469=x470.eq(x472);
        Formula x462=x463.and(x469);
        Expression x475=x398.join(x18);
        Expression x476=x380.join(x18);
        Formula x474=x475.eq(x476);
        Formula x461=x462.and(x474);
        Formula x437=x438.and(x461);
        Expression x481=x398.join(x19);
        Expression x480=x384.join(x481);
        Expression x484=x21.transpose();
        Expression x483=x484.closure();
        Expression x482=x221.join(x483);
        Formula x479=x480.in(x482);
        Expression x487=x398.join(x16);
        Expression x486=x384.join(x487);
        Formula x485=x486.eq(x9);
        Formula x478=x479.implies(x485);
        Formula x489=x479.not();
        Expression x492=x398.join(x16);
        Expression x491=x384.join(x492);
        Formula x490=x491.eq(x12);
        Formula x488=x489.implies(x490);
        Formula x477=x478.and(x488);
        Formula x436=x437.and(x477);
        Formula x412=x413.or(x436);
        Expression x497=x380.join(x16);
        Expression x496=x384.join(x497);
        Formula x495=x496.eq(x12);
        Expression x502=x398.join(x16);
        Expression x501=x384.join(x502);
        Formula x500=x501.eq(x8);
        Expression x505=x398.join(x19);
        Expression x504=x384.join(x505);
        Expression x507=x380.join(x19);
        Expression x506=x384.join(x507);
        Formula x503=x504.eq(x506);
        Formula x499=x500.and(x503);
        Expression x509=x398.join(x18);
        Expression x510=x380.join(x18);
        Formula x508=x509.eq(x510);
        Formula x498=x499.and(x508);
        Formula x494=x495.and(x498);
        Expression x513=x398.join(x17);
        Expression x512=x384.join(x513);
        Formula x511=x512.eq(x20);
        Formula x493=x494.and(x511);
        Formula x411=x412.or(x493);
        Formula x387=x388.or(x411);
        Expression x518=x380.join(x16);
        Expression x517=x384.join(x518);
        Formula x516=x517.eq(x10);
        Expression x523=x398.join(x19);
        Expression x522=x384.join(x523);
        Expression x525=x380.join(x19);
        Expression x524=x384.join(x525);
        Formula x521=x522.eq(x524);
        Expression x528=x398.join(x16);
        Expression x527=x384.join(x528);
        Formula x526=x527.eq(x11);
        Formula x520=x521.and(x526);
        Expression x532=x398.join(x19);
        Expression x531=x384.join(x532);
        Expression x533=x398.join(x18);
        Expression x530=x531.join(x533);
        Formula x529=x530.eq(x384);
        Formula x519=x520.and(x529);
        Formula x515=x516.and(x519);
        Expression x537=x398.join(x17);
        Expression x536=x384.join(x537);
        Expression x539=x380.join(x17);
        Expression x538=x384.join(x539);
        Formula x535=x536.eq(x538);
        Variable x542=Variable.unary("L2Trans_j");
        Expression x545=x398.join(x19);
        Expression x544=x384.join(x545);
        Expression x543=x7.difference(x544);
        Decls x541=x542.oneOf(x543);
        Expression x548=x398.join(x18);
        Expression x547=x542.join(x548);
        Expression x550=x380.join(x18);
        Expression x549=x542.join(x550);
        Formula x546=x547.eq(x549);
        Formula x540=x546.forAll(x541);
        Formula x534=x535.and(x540);
        Formula x514=x515.and(x534);
        Formula x386=x387.or(x514);
        Expression x556=x398.join(x16);
        Expression x555=x384.join(x556);
        Expression x558=x380.join(x16);
        Expression x557=x384.join(x558);
        Formula x554=x555.eq(x557);
        Expression x561=x398.join(x17);
        Expression x560=x384.join(x561);
        Expression x563=x380.join(x17);
        Expression x562=x384.join(x563);
        Formula x559=x560.eq(x562);
        Formula x553=x554.and(x559);
        Expression x566=x398.join(x19);
        Expression x565=x384.join(x566);
        Expression x568=x380.join(x19);
        Expression x567=x384.join(x568);
        Formula x564=x565.eq(x567);
        Formula x552=x553.and(x564);
        Formula x551=x552.not();
        Formula x385=x386.and(x551);
        Formula x382=x385.forSome(x383);
        Formula x378=x382.forAll(x379);
        Formula x377=x378.not();
        Formula x569=x0.eq(x0);
        Formula x570=x1.eq(x1);
        Formula x571=x2.eq(x2);
        Formula x572=x3.eq(x3);
        Formula x573=x4.eq(x4);
        Formula x574=x5.eq(x5);
        Formula x575=x6.eq(x6);
        Formula x576=x7.eq(x7);
        Formula x577=x8.eq(x8);
        Formula x578=x9.eq(x9);
        Formula x579=x10.eq(x10);
        Formula x580=x11.eq(x11);
        Formula x581=x12.eq(x12);
        Formula x582=x13.eq(x13);
        Formula x583=x14.eq(x14);
        Formula x584=x15.eq(x15);
        Formula x585=x16.eq(x16);
        Formula x586=x17.eq(x17);
        Formula x587=x18.eq(x18);
        Formula x588=x19.eq(x19);
        Formula x589=x20.eq(x20);
        Formula x590=x21.eq(x21);
        Formula x591=x22.eq(x22);
        Formula x592=x23.eq(x23);
        Formula x593=x24.eq(x24);
        Formula x594=x25.eq(x25);
