...
public final class ringleadLeaderHighestCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x42=x43.no();
        Variable x46=Variable.unary("LeaderHighest_this");
        ...
        Variable x57=Variable.unary("LeaderHighest_this");
        ...
        Variable x66=Variable.unary("LeaderHighest_this");
        ...
        Variable x76=Variable.unary("LeaderHighest_this");
        ...
        Variable x83=Variable.unary("LeaderHighest_this");
        ...
        Variable x92=Variable.unary("LeaderHighest_this");
        ...
        Variable x99=Variable.unary("LeaderHighest_this");
        ...
        Variable x108=Variable.unary("LeaderHighest_this");
        ...
        Variable x118=Variable.unary("LeaderHighest_this");
        ...
        Variable x127=Variable.unary("LeaderHighest_this");
        ...
        Variable x150=Variable.unary("LeaderHighest_this");
        ...
        Variable x158=Variable.unary("LeaderHighest_this");
        ...
        Variable x182=Variable.unary("LeaderHighest_this");
        ...
        Variable x191=Variable.unary("LeaderHighest_this");
        ...
        Variable x200=Variable.unary("LeaderHighest_this");
        ...
        Variable x209=Variable.unary("LeaderHighest_this");
        ...
        Variable x216=Variable.unary("LeaderHighest_this");
        ...
        Variable x225=Variable.unary("LeaderHighest_this");
        ...
        Variable x278=Variable.unary("LeaderHighest_n");
        ...
        Variable x284=Variable.unary("LeaderHighest_n");
        ...
        Variable x297=Variable.unary("LeaderHighest_n");
        ...
        Variable x304=Variable.unary("LeaderHighest_n");
        Decls x303=x304.oneOf(x51);
        Variable x308=Variable.unary("LeaderHighest_t");
        ...
        Variable x492=Variable.unary("LeaderHighest_pre");
        ...
        Variable x503=Variable.unary("LeaderHighest_t");
        ...
        Variable x524=Variable.unary("LeaderHighest_n");
        Decls x523=x524.oneOf(x51);
        Variable x526=Variable.unary("LeaderHighest_m");
        ...
        Variable x544=Variable.unary("LeaderHighest_n");
        ...
        Variable x553=Variable.unary("LeaderHighest_n");
        Decls x552=x553.oneOf(x51);
        Variable x555=Variable.unary("LeaderHighest_m");
        ...
        Variable x590=Variable.unary("LeaderHighest_t");
        Decls x589=x590.oneOf(x14);
        Variable x592=Variable.unary("LeaderHighest_n");
        Decls x591=x592.oneOf(x51);
        Decls x588=x589.and(x591);
        Expression x598=x590.join(x30);
        Expression x597=x592.join(x598);
        Expression x596=x597.join(x24);
        Formula x595=x596.eq(x6);
        Formula x594=x595.not();
        Expression x601=x39.join(x51);
        Expression x600=x51.difference(x601);
        Formula x599=x592.eq(x600);
        Formula x593=x594.or(x599);
        Formula x587=x593.forAll(x588);
        Formula x586=x587.not();
        Formula x602=x0.eq(x0);
        Formula x603=x1.eq(x1);
        Formula x604=x2.eq(x2);
        Formula x605=x3.eq(x3);
        Formula x606=x4.eq(x4);
        Formula x607=x5.eq(x5);
        Formula x608=x6.eq(x6);
        Formula x609=x7.eq(x7);
        Formula x610=x8.eq(x8);
        Formula x611=x9.eq(x9);
        Formula x612=x10.eq(x10);
        Formula x613=x11.eq(x11);
        Formula x614=x12.eq(x12);
        Formula x615=x13.eq(x13);
        Formula x616=x14.eq(x14);
        Formula x617=x15.eq(x15);
        Formula x618=x16.eq(x16);
        Formula x619=x17.eq(x17);
        Formula x620=x18.eq(x18);
        Formula x621=x19.eq(x19);
        Formula x622=x20.eq(x20);
        Formula x623=x21.eq(x21);
        Formula x624=x22.eq(x22);
        Formula x625=x23.eq(x23);
        Formula x626=x24.eq(x24);
        Formula x627=x25.eq(x25);
        Formula x628=x26.eq(x26);
        Formula x629=x27.eq(x27);
        Formula x630=x28.eq(x28);
        Formula x631=x29.eq(x29);
        Formula x632=x30.eq(x30);
        Formula x633=x31.eq(x31);
        Formula x634=x32.eq(x32);
        Formula x635=x33.eq(x33);
        Formula x636=x34.eq(x34);
        Formula x637=x35.eq(x35);
        Formula x638=x36.eq(x36);
        Formula x639=x37.eq(x37);
        Formula x640=x38.eq(x38);
        Formula x641=x39.eq(x39);
        Formula x642=x40.eq(x40);
