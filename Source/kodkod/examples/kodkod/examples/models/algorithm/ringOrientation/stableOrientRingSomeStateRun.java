...
public final class stableOrientRingSomeStateRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x23=x24.no();
        Variable x27=Variable.unary("SomeState_this");
        ...
        Variable x37=Variable.unary("SomeState_this");
        ...
        Variable x62=Variable.unary("SomeState_this");
        ...
        Variable x86=Variable.unary("SomeState_this");
        ...
        Variable x109=Variable.unary("SomeState_this");
        ...
        Variable x132=Variable.unary("SomeState_this");
        ...
        Variable x141=Variable.unary("SomeState_this");
        Decls x140=x141.oneOf(x7);
        Variable x144=Variable.unary("SomeState_p");
        ...
        Variable x164=Variable.unary("SomeState_p");
        ...
        Variable x203=Variable.unary("SomeState_tp");
        ...
        Variable x209=Variable.unary("SomeState_p");
        ...
        Variable x325=Variable.unary("ring_n");
        Decls x324=x325.oneOf(x6);
        Expression x329=x19.join(x18);
        Expression x328=x325.join(x329);
        Formula x327=x328.one();
        Expression x333=x329.closure();
        Expression x335=x195.product(Expression.UNIV);
        Expression x334=Expression.IDEN.intersection(x335);
        Expression x332=x333.union(x334);
        Expression x331=x325.join(x332);
        Formula x330=x6.in(x331);
        Formula x326=x327.and(x330);
        Formula x323=x326.forAll(x324);
        Formula x322=x323.not();
        Variable x338=Variable.unary("SomeState_t");
        Decls x337=x338.oneOf(x7);
        Variable x341=Variable.unary("ring_n");
        Decls x340=x341.oneOf(x6);
        Expression x345=x338.join(x18);
        Expression x344=x341.join(x345);
        Formula x343=x344.one();
        Expression x349=x345.closure();
        Expression x351=x195.product(Expression.UNIV);
        Expression x350=Expression.IDEN.intersection(x351);
        Expression x348=x349.union(x350);
        Expression x347=x341.join(x348);
        Formula x346=x6.in(x347);
        Formula x342=x343.and(x346);
        Formula x339=x342.forAll(x340);
        Formula x336=x339.forSome(x337);
        Formula x352=x0.eq(x0);
        Formula x353=x1.eq(x1);
        Formula x354=x2.eq(x2);
        Formula x355=x3.eq(x3);
        Formula x356=x4.eq(x4);
        Formula x357=x5.eq(x5);
        Formula x358=x6.eq(x6);
        Formula x359=x7.eq(x7);
        Formula x360=x8.eq(x8);
        Formula x361=x9.eq(x9);
        Formula x362=x10.eq(x10);
        Formula x363=x11.eq(x11);
        Formula x364=x12.eq(x12);
        Formula x365=x13.eq(x13);
        Formula x366=x14.eq(x14);
        Formula x367=x15.eq(x15);
        Formula x368=x16.eq(x16);
        Formula x369=x17.eq(x17);
        Formula x370=x18.eq(x18);
        Formula x371=x19.eq(x19);
        Formula x372=x20.eq(x20);
        Formula x373=x21.eq(x21);
