...
public final class orderingCorrectCheck5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        x6_upper.add(factory.tuple("elem$4"));
        ...
        x8_upper.add(factory.tuple("elem$4"));
        ...
        x9_upper.add(factory.tuple("elem$0").product(factory.tuple("elem$4")));
        ...
        x9_upper.add(factory.tuple("elem$1").product(factory.tuple("elem$4")));
        ...
        x9_upper.add(factory.tuple("elem$2").product(factory.tuple("elem$4")));
        ...
        x9_upper.add(factory.tuple("elem$3").product(factory.tuple("elem$4")));
        x9_upper.add(factory.tuple("elem$4").product(factory.tuple("elem$0")));
        x9_upper.add(factory.tuple("elem$4").product(factory.tuple("elem$1")));
        x9_upper.add(factory.tuple("elem$4").product(factory.tuple("elem$2")));
        x9_upper.add(factory.tuple("elem$4").product(factory.tuple("elem$3")));
        x9_upper.add(factory.tuple("elem$4").product(factory.tuple("elem$4")));
        ...
        x10_upper.add(factory.tuple("elem$4"));
