...
public final class listsShowRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> atomlist = Arrays.asList(
                ...
                "-6", "-7", "-8", "0", "1", "2",
                "3", "4", "5", "6", "7", "List$0",
                "List$1", "List$2", "List$3", "Thing$0", "Thing$1", "Thing$2",
                "Thing$3"
        );
        ...
        Formula x14=x15.no();
        Variable x18=Variable.unary("show_this");
        ...
        Variable x28=Variable.unary("show_this");
        ...
        Variable x45=Variable.unary("show_this");
        ...
        Variable x54=Variable.unary("show_L");
        ...
        Variable x72=Variable.unary("show_a");
        Decls x71=x72.oneOf(x33);
        Variable x74=Variable.unary("show_b");
        ...
        Variable x103=Variable.unary("show_e");
        Decls x102=x103.oneOf(x8);
        Variable x105=Variable.unary("show_L");
        ...
        Variable x111=Variable.unary("show_a");
        Decls x110=x111.oneOf(x7);
        Variable x113=Variable.unary("show_b");
        ...
        Variable x142=Variable.unary("show_a");
        Decls x141=x142.oneOf(x7);
        Variable x144=Variable.unary("show_b");
        Decls x143=x144.oneOf(x7);
        Decls x140=x141.and(x143);
        Formula x147=x142.eq(x144);
        Formula x146=x147.not();
        Expression x149=x142.join(x10);
        Formula x148=x144.in(x149);
        Formula x145=x146.and(x148);
        Formula x139=x145.forSome(x140);
        ...
        Formula x13=Formula.compose(FormulaOperator.AND, x14, x16, x23, x26, x34, x36, x41, x43, x48, x50, x52, x69, x100, x108, x139, x150, x151, x152, x153, x154, x155, x156, x157, x158, x159, x160, x161, x162);
