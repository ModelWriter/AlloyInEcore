...
public final class listsReflexiveCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x14=x15.no();
        Variable x18=Variable.unary("reflexive_this");
        ...
        Variable x28=Variable.unary("reflexive_this");
        ...
        Variable x38=Variable.unary("reflexive_this");
        ...
        Variable x45=Variable.unary("reflexive_this");
        ...
        Variable x54=Variable.unary("reflexive_L");
        ...
        Variable x72=Variable.unary("reflexive_a");
        Decls x71=x72.oneOf(x33);
        Variable x74=Variable.unary("reflexive_b");
        ...
        Variable x103=Variable.unary("reflexive_e");
        Decls x102=x103.oneOf(x8);
        Variable x105=Variable.unary("reflexive_L");
        ...
        Variable x111=Variable.unary("reflexive_a");
        Decls x110=x111.oneOf(x7);
        Variable x113=Variable.unary("reflexive_b");
        ...
        Variable x142=Variable.unary("reflexive_L");
        Decls x141=x142.oneOf(x33);
        Expression x144=x142.join(x9);
        Formula x143=x142.in(x144);
        ...
        Formula x13=Formula.compose(FormulaOperator.AND, x14, x16, x23, x26, x34, x36, x41, x43, x48, x50, x52, x69, x100, x108, x139, x145, x146, x147, x148, x149, x150, x151, x152, x153, x154, x155, x156, x157);
