...
public final class listsEmptiesCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x14=x15.no();
        Variable x18=Variable.unary("empties_this");
        ...
        Variable x28=Variable.unary("empties_this");
        ...
        Variable x38=Variable.unary("empties_this");
        ...
        Variable x45=Variable.unary("empties_this");
        ...
        Variable x54=Variable.unary("empties_L");
        ...
        Variable x72=Variable.unary("empties_a");
        Decls x71=x72.oneOf(x33);
        Variable x74=Variable.unary("empties_b");
        ...
        Variable x103=Variable.unary("empties_e");
        Decls x102=x103.oneOf(x8);
        Variable x105=Variable.unary("empties_L");
        ...
        Variable x111=Variable.unary("empties_a");
        Decls x110=x111.oneOf(x7);
        Variable x113=Variable.unary("empties_b");
        ...
        Variable x143=Variable.unary("empties_a");
        Decls x142=x143.oneOf(x8);
        Variable x145=Variable.unary("empties_b");
        Decls x144=x145.oneOf(x8);
        Decls x141=x142.and(x144);
        Expression x147=x145.join(x9);
        Formula x146=x143.in(x147);
        Formula x140=x146.forAll(x141);
        Formula x139=x140.not();
        Formula x148=x0.eq(x0);
        Formula x149=x1.eq(x1);
        Formula x150=x2.eq(x2);
        Formula x151=x3.eq(x3);
        Formula x152=x4.eq(x4);
        Formula x153=x5.eq(x5);
        Formula x154=x6.eq(x6);
        Formula x155=x7.eq(x7);
        Formula x156=x8.eq(x8);
        Formula x157=x9.eq(x9);
        Formula x158=x10.eq(x10);
        Formula x159=x11.eq(x11);
        Formula x160=x12.eq(x12);
