...
public final class lifeSquareRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x19=Variable.unary("Square_this");
        ...
        Variable x30=Variable.unary("Square_this");
        ...
        Variable x39=Variable.unary("Square_this");
        ...
        Variable x54=Variable.unary("Square_p");
        ...
        Variable x62=Variable.unary("Square_p");
        ...
        Variable x81=Variable.unary("Square_p");
        ...
        Variable x116=Variable.unary("Square_pre");
        ...
        Variable x122=Variable.unary("Square_p");
        ...
        Expression x187=x10.closure();
        Expression x189=x96.product(Expression.UNIV);
        Expression x188=Expression.IDEN.intersection(x189);
        Expression x186=x187.union(x188);
        Expression x185=x6.join(x186);
        IntExpression x184=x185.count();
        Expression x193=x11.closure();
        Expression x195=x96.product(Expression.UNIV);
        Expression x194=Expression.IDEN.intersection(x195);
        Expression x192=x193.union(x194);
        Expression x191=x6.join(x192);
        IntExpression x190=x191.count();
        Formula x183=x184.eq(x190);
        Formula x196=x0.eq(x0);
        Formula x197=x1.eq(x1);
        Formula x198=x2.eq(x2);
        Formula x199=x3.eq(x3);
        Formula x200=x4.eq(x4);
        Formula x201=x5.eq(x5);
        Formula x202=x6.eq(x6);
        Formula x203=x7.eq(x7);
        Formula x204=x8.eq(x8);
        Formula x205=x9.eq(x9);
        Formula x206=x10.eq(x10);
        Formula x207=x11.eq(x11);
        Formula x208=x12.eq(x12);
        Formula x209=x13.eq(x13);
        Formula x210=x14.eq(x14);
        Formula x211=x15.eq(x15);
        Formula x16=Formula.compose(FormulaOperator.AND, x17, x25, x28, x35, x37, x42, x44, x47, x51, x52, x60, x79, x107, x114, x183, x196, x197, x198, x199, x200, x201, x202, x203, x204, x205, x206, x207, x208, x209, x210, x211);
