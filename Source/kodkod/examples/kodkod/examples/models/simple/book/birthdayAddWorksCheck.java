...
public final class birthdayAddWorksCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x14=Variable.unary("AddWorks_this");
        ...
        Variable x22=Variable.unary("AddWorks_this");
        ...
        Variable x49=Variable.unary("AddWorks_bb");
        Decls x48=x49.oneOf(x8);
        Variable x51=Variable.unary("AddWorks_bb'");
        Decls x50=x51.oneOf(x8);
        Variable x53=Variable.unary("AddWorks_n");
        Decls x52=x53.oneOf(x6);
        Variable x55=Variable.unary("AddWorks_d");
        Decls x54=x55.oneOf(x7);
        Variable x57=Variable.unary("AddWorks_d'");
        Decls x56=x57.loneOf(x7);
        Decls x47=x48.and(x50).and(x52).and(x54).and(x56);
        Expression x62=x51.join(x10);
        Expression x64=x49.join(x10);
        Expression x65=x53.product(x55);
        Expression x63=x64.override(x65);
        Formula x61=x62.eq(x63);
        Expression x68=x51.join(x10);
        Expression x67=x53.join(x68);
        Formula x66=x57.eq(x67);
        Formula x60=x61.and(x66);
        Formula x59=x60.not();
        Formula x69=x55.eq(x57);
        Formula x58=x59.or(x69);
        Formula x46=x58.forAll(x47);
        Formula x45=x46.not();
        Formula x70=x0.eq(x0);
        Formula x71=x1.eq(x1);
        Formula x72=x2.eq(x2);
        Formula x73=x3.eq(x3);
        Formula x74=x4.eq(x4);
        Formula x75=x5.eq(x5);
        Formula x76=x6.eq(x6);
        Formula x77=x7.eq(x7);
        Formula x78=x8.eq(x8);
        Formula x79=x9.eq(x9);
        Formula x80=x10.eq(x10);
