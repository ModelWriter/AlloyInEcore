...
public final class file_systemCheck2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x119=Variable.unary("OneParent_correctVersion_d");
        Expression x120=x21.difference(x7);
        Decls x118=x119.oneOf(x120);
        Expression x123=x119.join(x13);
        Formula x122=x123.one();
        Expression x125=x15.join(x119);
        Formula x124=x125.one();
        Formula x121=x122.and(x124);
        Formula x117=x121.forAll(x118);
        Formula x116=x117.not();
        Variable x128=Variable.unary("NoDirAliases_o");
        Decls x127=x128.oneOf(x21);
        Expression x131=x15.transpose();
        Expression x130=x128.join(x131);
        Formula x129=x130.lone();
        Formula x126=x129.forAll(x127);
        Formula x115=x116.or(x126);
        ...
        Formula x16=Formula.compose(FormulaOperator.AND, x17, x19, x23, x24, x25, x34, x36, x41, x44, x51, x53, x89, x96, x98, x106, x108, x114, x132, x133, x134, x135, x136, x137, x138, x139, x140, x141, x142, x143, x144, x145, x146, x147);
