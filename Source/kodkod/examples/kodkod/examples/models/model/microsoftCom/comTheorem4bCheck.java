...
public final class comTheorem4bCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x24=Variable.unary("Theorem4b_this");
        ...
        Variable x49=Variable.unary("Theorem4b_this");
        ...
        Variable x56=Variable.unary("Theorem4b_this");
        ...
        Variable x65=Variable.unary("Theorem4b_this");
        ...
        Variable x74=Variable.unary("Theorem4b_this");
        ...
        Variable x92=Variable.unary("Theorem4b_this");
        ...
        Variable x99=Variable.unary("Theorem4b_this");
        ...
        Variable x106=Variable.unary("Theorem4b_this");
        ...
        Variable x116=Variable.unary("Theorem4b_this");
        ...
        Variable x126=Variable.unary("Theorem4b_this");
        ...
        Variable x133=Variable.unary("Theorem4b_this");
        ...
        Variable x141=Variable.unary("Theorem4b_c1");
        Decls x140=x141.oneOf(x85);
        Variable x143=Variable.unary("Theorem4b_c2");
        ...
        Variable x152=Variable.unary("Theorem4b_unknown");
        Decls x151=x152.oneOf(x6);
        Variable x155=Variable.unary("Theorem4b_c");
        Decls x154=x155.oneOf(x85);
        Variable x158=Variable.unary("Theorem4b_i");
        ...
        Variable x166=Variable.unary("Theorem4b_c");
        ...
        Variable x174=Variable.unary("Theorem4b_i");
        Expression x175=x166.join(x15);
        Decls x173=x174.oneOf(x175);
        Variable x178=Variable.unary("Theorem4b_x");
        ...
        Variable x185=Variable.unary("Theorem4b_i");
        Decls x184=x185.oneOf(x7);
        Variable x188=Variable.unary("Theorem4b_x");
        ...
        Variable x198=Variable.unary("Theorem4b_i");
        ...
        Variable x205=Variable.unary("Theorem4b_i");
        Decls x204=x205.oneOf(x7);
        Variable x207=Variable.unary("Theorem4b_j");
        ...
        Variable x218=Variable.unary("Theorem4b_i");
        Decls x217=x218.oneOf(x7);
        Variable x220=Variable.unary("Theorem4b_j");
        ...
        Variable x230=Variable.unary("Theorem4b_c");
        ...
        Variable x237=Variable.unary("Theorem4b_outer");
        Decls x236=x237.oneOf(x85);
        Variable x240=Variable.unary("Theorem4b_inner");
        ...
        Variable x271=Variable.unary("Theorem4b_c1");
        Decls x270=x271.oneOf(x85);
        Variable x273=Variable.unary("Theorem4b_c2");
        Decls x272=x273.oneOf(x85);
        ...
        Formula x280=x271.in(x281);
        Formula x274=x275.or(x280);
        Formula x268=x274.forAll(x269);
        Formula x267=x268.not();
        Formula x282=x0.eq(x0);
        Formula x283=x1.eq(x1);
        Formula x284=x2.eq(x2);
        Formula x285=x3.eq(x3);
        Formula x286=x4.eq(x4);
        Formula x287=x5.eq(x5);
        Formula x288=x6.eq(x6);
        Formula x289=x7.eq(x7);
        Formula x290=x8.eq(x8);
        Formula x291=x9.eq(x9);
        Formula x292=x10.eq(x10);
        Formula x293=x11.eq(x11);
        Formula x294=x12.eq(x12);
        Formula x295=x13.eq(x13);
        Formula x296=x14.eq(x14);
        Formula x297=x15.eq(x15);
        Formula x298=x16.eq(x16);
        Formula x299=x17.eq(x17);
        Formula x300=x18.eq(x18);
        Formula x301=x19.eq(x19);
        Formula x302=x20.eq(x20);
        Formula x21=Formula.compose(FormulaOperator.AND, x22, x43, x47, x52, x54, x61, x63, x70, x72, x90, x95, x97, x102, x104, x112, x114, x122, x124, x129, x131, x136, x138, x150, x164, x183, x194, x196, x202, x215, x228, x235, x267, x282, x283, x284, x285, x286, x287, x288, x289, x290, x291, x292, x293, x294, x295, x296, x297, x298, x299, x300, x301, x302);
