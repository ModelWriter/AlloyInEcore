...
public final class comTheorem4aCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x24=Variable.unary("Theorem4a_this");
        ...
        Variable x49=Variable.unary("Theorem4a_this");
        ...
        Variable x56=Variable.unary("Theorem4a_this");
        ...
        Variable x65=Variable.unary("Theorem4a_this");
        ...
        Variable x74=Variable.unary("Theorem4a_this");
        ...
        Variable x92=Variable.unary("Theorem4a_this");
        ...
        Variable x99=Variable.unary("Theorem4a_this");
        ...
        Variable x106=Variable.unary("Theorem4a_this");
        ...
        Variable x116=Variable.unary("Theorem4a_this");
        ...
        Variable x126=Variable.unary("Theorem4a_this");
        ...
        Variable x133=Variable.unary("Theorem4a_this");
        ...
        Variable x141=Variable.unary("Theorem4a_c1");
        Decls x140=x141.oneOf(x85);
        Variable x143=Variable.unary("Theorem4a_c2");
        ...
        Variable x152=Variable.unary("Theorem4a_unknown");
        Decls x151=x152.oneOf(x6);
        Variable x155=Variable.unary("Theorem4a_c");
        Decls x154=x155.oneOf(x85);
        Variable x158=Variable.unary("Theorem4a_i");
        ...
        Variable x166=Variable.unary("Theorem4a_c");
        ...
        Variable x174=Variable.unary("Theorem4a_i");
        Expression x175=x166.join(x15);
        Decls x173=x174.oneOf(x175);
        Variable x178=Variable.unary("Theorem4a_x");
        ...
        Variable x185=Variable.unary("Theorem4a_i");
        Decls x184=x185.oneOf(x7);
        Variable x188=Variable.unary("Theorem4a_x");
        ...
        Variable x198=Variable.unary("Theorem4a_i");
        ...
        Variable x205=Variable.unary("Theorem4a_i");
        Decls x204=x205.oneOf(x7);
        Variable x207=Variable.unary("Theorem4a_j");
        ...
        Variable x218=Variable.unary("Theorem4a_i");
        Decls x217=x218.oneOf(x7);
        Variable x220=Variable.unary("Theorem4a_j");
        ...
        Variable x230=Variable.unary("Theorem4a_c");
        ...
        Variable x237=Variable.unary("Theorem4a_outer");
        Decls x236=x237.oneOf(x85);
        Variable x240=Variable.unary("Theorem4a_inner");
        ...
        Variable x271=Variable.unary("Theorem4a_c1");
        Decls x270=x271.oneOf(x85);
        Variable x273=Variable.unary("Theorem4a_c2");
        Decls x272=x273.oneOf(x9);
        Decls x269=x270.and(x272);
        Expression x278=x271.join(x15);
        Expression x279=x273.join(x15);
        Expression x277=x278.intersection(x279);
        Formula x276=x277.some();
        Formula x275=x276.not();
        Expression x281=x273.join(x16);
        Expression x282=x271.join(x16);
        Formula x280=x281.in(x282);
        Formula x274=x275.or(x280);
        Formula x268=x274.forAll(x269);
        ...
        Formula x302=x19.eq(x19);
        Formula x303=x20.eq(x20);
        Formula x21=Formula.compose(FormulaOperator.AND, x22, x43, x47, x52, x54, x61, x63, x70, x72, x90, x95, x97, x102, x104, x112, x114, x122, x124, x129, x131, x136, x138, x150, x164, x183, x194, x196, x202, x215, x228, x235, x267, x283, x284, x285, x286, x287, x288, x289, x290, x291, x292, x293, x294, x295, x296, x297, x298, x299, x300, x301, x302, x303);
