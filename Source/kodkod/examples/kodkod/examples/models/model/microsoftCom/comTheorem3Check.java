...
public final class comTheorem3Check {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x24=Variable.unary("Theorem3_this");
        ...
        Variable x49=Variable.unary("Theorem3_this");
        ...
        Variable x56=Variable.unary("Theorem3_this");
        ...
        Variable x65=Variable.unary("Theorem3_this");
        ...
        Variable x74=Variable.unary("Theorem3_this");
        ...
        Variable x92=Variable.unary("Theorem3_this");
        ...
        Variable x99=Variable.unary("Theorem3_this");
        ...
        Variable x106=Variable.unary("Theorem3_this");
        ...
        Variable x116=Variable.unary("Theorem3_this");
        ...
        Variable x126=Variable.unary("Theorem3_this");
        ...
        Variable x133=Variable.unary("Theorem3_this");
        ...
        Variable x141=Variable.unary("Theorem3_c1");
        Decls x140=x141.oneOf(x85);
        Variable x143=Variable.unary("Theorem3_c2");
        ...
        Variable x152=Variable.unary("Theorem3_unknown");
        Decls x151=x152.oneOf(x6);
        Variable x155=Variable.unary("Theorem3_c");
        Decls x154=x155.oneOf(x85);
        Variable x158=Variable.unary("Theorem3_i");
        ...
        Variable x166=Variable.unary("Theorem3_c");
        ...
        Variable x174=Variable.unary("Theorem3_i");
        Expression x175=x166.join(x15);
        Decls x173=x174.oneOf(x175);
        Variable x178=Variable.unary("Theorem3_x");
        ...
        Variable x185=Variable.unary("Theorem3_i");
        Decls x184=x185.oneOf(x7);
        Variable x188=Variable.unary("Theorem3_x");
        ...
        Variable x198=Variable.unary("Theorem3_i");
        ...
        Variable x205=Variable.unary("Theorem3_i");
        Decls x204=x205.oneOf(x7);
        Variable x207=Variable.unary("Theorem3_j");
        ...
        Variable x218=Variable.unary("Theorem3_i");
        Decls x217=x218.oneOf(x7);
        Variable x220=Variable.unary("Theorem3_j");
        ...
        Variable x230=Variable.unary("Theorem3_c");
        ...
        Variable x237=Variable.unary("Theorem3_outer");
        Decls x236=x237.oneOf(x85);
        Variable x240=Variable.unary("Theorem3_inner");
        ...
        Variable x270=Variable.unary("Theorem3_outer");
        Decls x269=x270.oneOf(x85);
        Variable x273=Variable.unary("Theorem3_inner");
        Expression x274=x270.join(x20);
        Decls x272=x273.oneOf(x274);
        Expression x276=x270.join(x19);
        Formula x275=x273.in(x276);
        Formula x271=x275.forAll(x272);
        Formula x268=x271.forAll(x269);
        Formula x267=x268.not();
        Formula x277=x0.eq(x0);
        Formula x278=x1.eq(x1);
        Formula x279=x2.eq(x2);
        Formula x280=x3.eq(x3);
        Formula x281=x4.eq(x4);
        Formula x282=x5.eq(x5);
        Formula x283=x6.eq(x6);
        Formula x284=x7.eq(x7);
        Formula x285=x8.eq(x8);
        Formula x286=x9.eq(x9);
        Formula x287=x10.eq(x10);
        Formula x288=x11.eq(x11);
        Formula x289=x12.eq(x12);
        Formula x290=x13.eq(x13);
        Formula x291=x14.eq(x14);
        Formula x292=x15.eq(x15);
        Formula x293=x16.eq(x16);
        Formula x294=x17.eq(x17);
        Formula x295=x18.eq(x18);
        Formula x296=x19.eq(x19);
        Formula x297=x20.eq(x20);
        Formula x21=Formula.compose(FormulaOperator.AND, x22, x43, x47, x52, x54, x61, x63, x70, x72, x90, x95, x97, x102, x104, x112, x114, x122, x124, x129, x131, x136, x138, x150, x164, x183, x194, x196, x202, x215, x228, x235, x267, x277, x278, x279, x280, x281, x282, x283, x284, x285, x286, x287, x288, x289, x290, x291, x292, x293, x294, x295, x296, x297);
