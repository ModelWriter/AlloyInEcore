...
public class NextXMIInstanceHandler extends AbstractHandler {

  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    final MessageDialog warningdialog = new MessageDialog(Activator.getShell(), "Next Instance",
        null, "The next instance will be found.", MessageDialog.INFORMATION,
    ...
    Job job = new Job("AlloyInEcore Reasoning Job") {
      ...
      protected IStatus run(IProgressMonitor monitor) {
        ...
        ModelExtenderTask task = new ModelExtenderTask(subMonitor, iFile, editorInput, uri,
            ModelExtenderTask.NEXT_SOLUTION);
        task.start();
