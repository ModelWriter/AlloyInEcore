...
public class PreviousXMIInstanceHandler extends AbstractHandler {

  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    final MessageDialog warningdialog = new MessageDialog(Activator.getShell(), "Previous Instance",
        null, "The previous instance will be found.", MessageDialog.INFORMATION,
    ...
    Job job = new Job("AlloyInEcore Reasoning Job") {
      ...
      protected IStatus run(IProgressMonitor monitor) {
        ...
        ModelExtenderTask task = new ModelExtenderTask(subMonitor, iFile, editorInput, uri,
            ModelExtenderTask.PREV_SOLUTION);
        task.start();
