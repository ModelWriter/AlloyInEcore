...
public class AIEEditor extends TextEditor implements ASTChangeListener {
  ...
  public static final String UNSAT_ERROR_ANNOTATION =
      "eu.modelwriter.core.alloyinecore.ui.editor.unsaterror";
  public static final String PARSER_ERROR_MARKER =
      "eu.modelwriter.core.alloyinecore.ui.editor.parseerrormarker";
  public static final String UNSAT_ERROR_MARKER =
      "eu.modelwriter.core.alloyinecore.ui.editor.unsaterrormarker";
  ...
  protected void initEditor() {
    ...
    astManager = new ASTModelManager(this);
  }
  ...
  private void parse() {
    try {
      AIEDocument document = (AIEDocument) getDocumentProvider().getDocument(getEditorInput());
      getASTManager().parseDocument(document,
          URI.createPlatformResourceURI(getIFile().getFullPath().toString(), true));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
