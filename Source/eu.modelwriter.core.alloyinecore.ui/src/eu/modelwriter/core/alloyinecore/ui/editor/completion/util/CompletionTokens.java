...
public interface CompletionTokens {
  ...
  String _ghost = "ghost";
  String _acyclic = "acyclic";
  String _transitive = "transitive";
  String _reflexive = "reflexive";
  String _irreflexive = "irreflexive";
  String _symmetric = "symmetric";
  String _asymmetric = "asymmetric";
  String _antisymmetric = "antisymmetric";
  String _total = "total";
  String _functional = "functional";
  String _surjective = "surjective";
  String _injective = "injective";
  String _bijective = "bijective";
  String _complete = "complete";
  String _bijection = "bijection";
  String _preorder = "preorder";
  String _equivalence = "equivalence";
  String _partialorder = "partialorder";
  String _totalorder = "totalorder";
