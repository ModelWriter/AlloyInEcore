...
public class VisualizeXmiInstance extends AbstractHandler {
    ...
    Display.getDefault().syncExec(new Runnable() {
      ...
      public void run() {
        ...
        try {
          ...
          marker.setAttribute(IDE.EDITOR_ID_ATTR, AIEVisualizationEditor.EDITOR_ID);
          marker.setAttribute(IMarker.TEXT, "Temporary Marker");
          marker.setAttribute("uri", uri.toString());
          IDE.openEditor(Activator.getActiveWorkbenchWindow().getActivePage(), marker);
          marker.delete();
