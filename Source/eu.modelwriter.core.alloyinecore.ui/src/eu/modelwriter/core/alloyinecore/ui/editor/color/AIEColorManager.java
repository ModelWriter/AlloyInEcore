...
public class AIEColorManager implements IColorManager, IColorManagerExtension {
  ...
  public AIEColorManager() {
    ...
    bindColor(IAIEColorConstants.AIE_SCOPE, new RGB(196, 155, 92));
//  bindColor(IAIEColorConstants.AIE_SCOPE, new RGB(170, 148, 148));
//  bindColor(IAIEColorConstants.AIE_SCOPE, new RGB(127, 127, 159));
